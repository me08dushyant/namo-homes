...
! function(a, b) {
    ...
    if ("object" != typeof window.google || !window.google.maps) throw "Hey Google Maps API is required. Please register the following JavaScript library http://maps.google.com/maps/api/js?sensor=true.";
    var a = function(a, b) {
            var c;
            if (a === b) return a;
            for (c in b) a[c] = b[c];
